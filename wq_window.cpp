...
void WQ_Window::agregarTodasLasSeriesDeTiempo(int numDatos, bool remplazar)
{
    ...
    vectorDatos = validador->obtenerVectorDatos(numDatos,0,0,60000000,1);
    ...
    vectorDatos = validador->obtenerVectorDatos(numDatos,0,inicio,inicio+10000000,1);
    ...
    vectorDatos = validador->obtenerVectorDatos(numDatos,0,inicio,inicio+1000000,1);
    ...
    vectorDatos = validador->obtenerVectorDatos(numDatos,0,inicio,inicio+100000,1);
    ...
    vectorDatos = validador->obtenerVectorDatos(numDatos,0,inicio,inicio+10000,1);
    ...
    vectorDatos = validador->obtenerVectorDatos(numDatos,0,inicio,inicio+1000,1);
